...
if __name__ == '__main__':
    ...
    environment_config = CalibrationEnvironmentConfig(seed=seed,
    ...
    evaluator_config = RayDistributedEvaluatorConfig(
        ...
        callbacks=[UpdateExperimentIndexCallback, SpringStiffnessPerturbationCallback, LoadTorqueNRMSEFitnessCallback],
    ...
    logger_config = CalibrationLoggerConfig(project_name='elastic_actuation_arm',
                                            group=args.wandb_group,
                                            tags=[args.wandb_tag],
                                            update_saver_path=True,
                                            parameter_labels=genome_config.parameter_labels,
                                            error_dimension_labels=environment_config.experiment_configurations[
                                                0].measurement_keys,
    ...
    if not args.analyze_only:
        ea.run()
    evaluation_results = ea.analyze(args.analyze_path)
